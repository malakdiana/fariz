            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="alert alert-success text-center">
                       <button style="border: solid 0px; background-color:rgba(255,255,255,0); ">  <h3><b>   Tenant 2 </b></h3></button>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="alert alert-info text-center">
                      <button style="border: solid 0px; background-color:rgba(255,255,255,0); ">   <h3><b>   Tenant 3 </b></h3></button>

                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="alert alert-warning text-center">
                       <button style="border: solid 0px; background-color:rgba(255,255,255,0); ">   <h3><b>   Tenant 4 </b></h3></button>
                    </div>
                </div>
